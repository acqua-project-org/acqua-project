...
import plugins.anomalydetector.NormalDistrib;
...
public class IFEstimator implements Pipelineable{
    ...
    private void calculateImpactFactorAndPutInFlowElement(FlowElement input, FlowElement output) throws Exception{
        ...
        MyLog.appendPToLogFile(this, "Summary of calculations: ife=%f rtt=%f shift=%f unreach=%f\n",
                finalIFE, finalRTTAvg, finalShiftAvg, finalUnreachable);
